    ...
    <div className="contact-background">
        <div className="contact-title">
            ...
            <div className="img-position">
                ...
                <a href="mailto:maximilianyoung52@gmail.com" target="blank"><img src={Gmail} className="contact-img" alt="gmail logo"></img></a>
                <a href="https://github.com/Maxthemilian52" target="blank"><img src={GitHub} className="contact-img" alt="github logo"></img></a>
            </div>
        </div>
    </div>
    )
