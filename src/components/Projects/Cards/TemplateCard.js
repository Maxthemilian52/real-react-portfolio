...
class TemplateCard extends React.Component{
    ...
    displayContent(){
        ...
        if(this.props.title==="E-Commerce Back End"){
            ...
            overview="This project provides the server-side functionality to an ecommerce website.  I took a working Express.js API and configured it to use Sequelize to inteact with a MySql database.  Functionality includes using GET, PUT, and POST routes to interact with the database.";
            technologies="This project used Express.js, Sequelize, and MySql alongside Insomnia in order to test routes.";
            challenges="One of the biggest challenges for this project was getting each individual route to work.  When two of the ten routes aren't working, even if they had been coded similarly, it gets frustrating.  This project really taught me a lesson in keeping a very sharp eye on proper syntax.";
            ...
            overview="The purpose of this project was to create a note taking application that could be used to write and save notes. This application uses an Express.js back end and saves and retrieves note data from a JSON file.";
            technologies="Express.js was the main technology for this application.";
            challenges="The biggest challenge while working on this project was getting the information from the database to populate the right fields.";
            ...
            challenges="This project was a big challenge when it came to creating unique IDs for Users and Comments, to provide the ability to comment on specific posts.  It was very interesting and fun working out all the kinks in order to get the routing to work correctly.";
            ...
            <div>
                <Card style={{ width: '100%' }}>
                    ...
                    <Card.Body>
                        ...
                        <Button onClick={this.displayContent} href="#description-section">View</Button>
                    </Card.Body>
                </Card>
            </div>
        );
